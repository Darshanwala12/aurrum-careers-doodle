...
export default function CareerCounsellorAvatar({ state = 'idle', speaking = false, size = 260, text = '' }) {
  ...
  return (
    <svg ref={svgRef} viewBox="0 0 200 380" width={size} height={size * 1.9}
      ...
      <defs>
        ...
        {/* Hair — warm chestnut brown, matching the reference sheet's loose wavy hair */}
        <radialGradient id={id('hair')} cx="30%" cy="18%" r="78%">
          <stop offset="0%"   stopColor="#7a4a2a" />
          <stop offset="40%"  stopColor="#54301c" />
          <stop offset="100%" stopColor="#301c10" />
        </radialGradient>
        <linearGradient id={id('hair-hi')} x1="0.18" y1="0" x2="0.5" y2="0.85">
          <stop offset="0%"   stopColor="#b07c46" stopOpacity="0.95" />
          <stop offset="100%" stopColor="#5a3620" stopOpacity="0" />
        </linearGradient>
        {/* Blazer — deep navy */}
        ...
        {/* Shoes — cream/nude heels, matching the reference sheet */}
        <linearGradient id={id('shoe')} x1="0" y1="0" x2="0.25" y2="1">
          <stop offset="0%"   stopColor="#fbf3e4" />
          <stop offset="100%" stopColor="#e6d2ac" />
        </linearGradient>
        {/* Eyes */}
      ...
      <g>
        ...
        <rect x="65" y="368" width="5" height="12" rx="1.2" fill="#c9a870" />
        <path d="M 65 368 Q 78 362 93 366 L 95 369 Q 95 375 92 376 Q 76 379 65 376 Z"
          fill={url('shoe')} />
        <path d="M 69 363 Q 82 360 91 364" fill="none" stroke="#c9a227" strokeWidth="0.8" opacity="0.45" strokeLinecap="round" />
        <ellipse cx="92.5" cy="369.5" rx="2.2" ry="1.3" fill="#d8bd8a" opacity="0.55" />
        {/* Right shoe — mirrored */}
        <rect x="130" y="368" width="5" height="12" rx="1.2" fill="#c9a870" />
        <path d="M 135 368 Q 122 362 107 366 L 105 369 Q 105 375 108 376 Q 124 379 135 376 Z"
          fill={url('shoe')} />
        <path d="M 131 363 Q 118 360 109 364" fill="none" stroke="#c9a227" strokeWidth="0.8" opacity="0.45" strokeLinecap="round" />
        <ellipse cx="107.5" cy="369.5" rx="2.2" ry="1.3" fill="#d8bd8a" opacity="0.55" />
      </g>
